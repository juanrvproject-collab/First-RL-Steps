...
The code also includes a "guide" of the steps meant to follow during every creation of an Q-Learning solution.
The creation of the environment was possible thanks to an copilotation of Gemini, dispite that I could manage to train succesfully the agent.
